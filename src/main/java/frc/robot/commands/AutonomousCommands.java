...
public class AutonomousCommands {
  ...
  //TODO: Make sure superstructure states are correct
        ...
        .onTrue(
            Commands.sequence(
                ...
                Commands.parallel(
                    DriveCommands.autoAlignReefCoral(drive, cameras),
                    Commands.waitUntil(() -> superstructure.atGoal())),
                superstructure.runActionWithTimeout(V3_EpsilonSuperstructureStates.L4_PREP, 
                    V3_EpsilonSuperstructureStates.L4_SCORE, 0.25),
                Commands.deadline(
                    path2.cmd(),
                    V3_EpsilonCompositeCommands.intakeCoralDriverSequence(
                        superstructure, intake),
                ...
                Commands.parallel(
                    ...
                    Commands.waitUntil(() -> superstructure.atGoal())),
                superstructure.runActionWithTimeout(V3_EpsilonSuperstructureStates.L4_PREP, 
                    V3_EpsilonSuperstructureStates.L4_SCORE, 0.5)));
