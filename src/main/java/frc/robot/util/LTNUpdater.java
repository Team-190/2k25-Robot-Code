...
public class LTNUpdater {
    ...
    /**
     * Register all subsystem auto-updates. Call this once during robot initialization.
     * Then call LoggedTunableNumber.updateAll() periodically in robotPeriodic().
     */
    ...
    public static void registerAll(Drive drive, ElevatorFSM elevator, FunnelFSM funnel, V2_RedundancyIntake intake, V2_RedundancyManipulator manipulator) {
        registerDrive(drive);
        registerElevator(elevator);
        registerFunnel(funnel);
    ...
    public static void registerAll(Drive drive, ElevatorFSM elevator, V3_EpsilonIntake intake, V3_EpsilonManipulator manipulator) {
        registerDrive(drive);
        registerElevator(elevator);
        registerIntake(intake);
