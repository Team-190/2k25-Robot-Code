  ...
  public static final void updateFunnel(Funnel funnel) {
    LoggedTunableNumber.ifChanged(
        ...
        () -> {
          ...
          funnel.updateConstraints(FunnelConstants.SERIALIZER_MOTOR_CONSTRAINTS.MAX_ACCELERATION().get(), FunnelConstants.SERIALIZER_MOTOR_CONSTRAINTS.MAX_VELOCITY().get());
          funnel.updateThresholds(FunnelConstants.ANGLE_THRESHOLDS.MAX_ANGLE_RADIANS().get(), FunnelConstants.ANGLE_THRESHOLDS.MIN_ANGLE_RADIANS().get());
        },
