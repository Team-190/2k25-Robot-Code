...
public class FunnelConstants {
  ...
  static {
    switch (Constants.ROBOT) {
      ...
      default:
        ...
        CANCODER_ABSOLUTE_OFFSET_RADIANS = Rotation2d.fromRadians(0.0);

        CURRENT_LIMITS = new FunnelCurrentLimits(20.0, 20.0, 20.0, 20.0);
        ANGLE_THRESHOLDS = new Thresholds(Units.degreesToRadians(90.0), 0.0);
        CLAP_DADDY_PARAMS = new FunnelParams(DCMotor.getKrakenX60Foc(1), 0.0042);
        ROLLER_PARAMS = new FunnelParams(DCMotor.getKrakenX60Foc(1), 0.0042);
  ...
  public enum FunnelState {
    STOW(Rotation2d.fromDegrees(60.0)),
