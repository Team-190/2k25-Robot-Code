  ...
  public Funnel(FunnelIO io) {
    ...
    intakeCharacterizationRoutine =
        new SysIdRoutine(
            ...
            new SysIdRoutine.Mechanism((volts) -> io.setIntakeVoltage(volts.in(Volts)), null, this));
    ...
    public Command sysIdRoutine() {
        return Commands.sequence(
            ...
            Commands.parallel(crabCharacterizationRoutine.quasistatic(Direction.kForward), intakeCharacterizationRoutine.quasistatic(Direction.kForward)),
            Commands.waitSeconds(4),
            Commands.parallel(crabCharacterizationRoutine.quasistatic(Direction.kReverse), intakeCharacterizationRoutine.quasistatic(Direction.kReverse)),
            Commands.waitSeconds(4),
            Commands.parallel(crabCharacterizationRoutine.dynamic(Direction.kForward), intakeCharacterizationRoutine.dynamic(Direction.kForward)),
            Commands.waitSeconds(4),
            Commands.parallel(crabCharacterizationRoutine.dynamic(Direction.kReverse), intakeCharacterizationRoutine.dynamic(Direction.kReverse)));
    }
