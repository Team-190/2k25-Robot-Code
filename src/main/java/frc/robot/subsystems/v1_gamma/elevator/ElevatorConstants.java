...
public class ElevatorConstants {
    ...
    static {
        ...
        GAINS = new Gains(new LoggedTunableNumber("Elevator/Gains/kP", 0.1),
        ...
        CONSTRAINTS = new Constraints(
            new LoggedTunableNumber("Elevator/Max Acceleration", 4), new LoggedTunableNumber("Elevator/Goal Tolerance", 0.01));
