...
public class V3_PootClimber extends SubsystemBase {
  private final V3_PootClimberIO io;
  private final V3_PootClimberIOInputsAutoLogged inputs;
  ...
  public V3_PootClimber(V3_PootClimberIO io) {
    this.io = io;
    inputs = new V3_PootClimberIOInputsAutoLogged();
            ...
            .until(
                () ->
                    inputs.deploymentPosition.getRadians()
                            <= V3_PootClimberConstants.CLIMBER_CLIMBED_DEPLOYED_RADIANS
                        || override)
