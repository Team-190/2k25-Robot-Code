...
public class V3_PootClimberIOTalonFX implements V3_PootClimberIO {
  ...
  public V3_PootClimberIOTalonFX() {
    rollerTalonFX = new TalonFX(V3_PootClimberConstants.ROLLER_CAN_ID);
    deploymentTalonFX = new TalonFX(V3_PootClimberConstants.DEPLOYMENT_CAN_ID);
  ...
  public boolean isClimbed() {
    return Units.rotationsToRadians(deploymentPositionRotations.getValueAsDouble())
        <= V3_PootClimberConstants.CLIMBER_CLIMBED_RADIANS;
  }
}
