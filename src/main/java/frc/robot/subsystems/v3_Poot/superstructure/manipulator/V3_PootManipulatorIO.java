...
public interface V3_PootManipulatorIO {
  ...
  public default void setManipulatorState(V3_PootManipulatorConstants.ManipulatorArmState state) {}
  ...
  public default void updateSlot2ArmGains(
      double kP, double kD, double kS, double kV, double kA, double kG) {}
