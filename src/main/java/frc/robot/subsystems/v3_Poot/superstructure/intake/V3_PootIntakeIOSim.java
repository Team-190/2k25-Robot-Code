...
public class V3_PootIntakeIOSim implements V3_PootIntakeIO {
  ...
  public V3_PootIntakeIOSim() {
    pivotMotorSim =
        new SingleJointedArmSim(
            LinearSystemId.createSingleJointedArmSystem(
                V3_PootIntakeConstants.PIVOT_PARAMS.MOTOR(),
                V3_PootIntakeConstants.PIVOT_PARAMS.MASS_KG(),
                V3_PootIntakeConstants.PIVOT_PARAMS.PIVOT_GEAR_RATIO()),
            V3_PootIntakeConstants.PIVOT_PARAMS.MOTOR(),
            V3_PootIntakeConstants.PIVOT_PARAMS.PIVOT_GEAR_RATIO(),
            1,
            V3_PootIntakeConstants.PIVOT_PARAMS.MIN_ANGLE().getRadians(),
            V3_PootIntakeConstants.PIVOT_PARAMS.MAX_ANGLE().getRadians(),
            true,
            V3_PootIntakeConstants.PIVOT_PARAMS.MIN_ANGLE().getRadians());
    ...
    rollerInnerMotorSim =
        new DCMotorSim(
            LinearSystemId.createDCMotorSystem(
                V3_PootIntakeConstants.ROLLER_PARAMS.MOTOR(),
                0.04,
    ...
    armFeedbackController =
        new ProfiledPIDController(
            ...
            V3_PootIntakeConstants.PIVOT_CONSTRAINTS.getTrapezoidConstraints());
