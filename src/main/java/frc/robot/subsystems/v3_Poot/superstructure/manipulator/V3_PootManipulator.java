...
public class V3_PootManipulator {
  private final V3_PootManipulatorIO io;
  ...
  public V3_PootManipulator(V3_PootManipulatorIO io) {
    this.io = io;
  ...
  private double holdVoltage() {
    return RobotState.isHasAlgae() ? -12.0 : -1;
  }
   ...
   */
  public Command sysIdRoutine(V3_PootSuperstructure superstructure, ElevatorFSM elevator) {
    ...
    return Commands.sequence(
        superstructure.runGoal(V3_PootSuperstructureStates.OVERRIDE),
   ...
   */
  public void setManipulatorState(V3_PootManipulatorConstants.ManipulatorArmState state) {
   ...
   */
  public void setRollerGoal(V3_PootManipulatorConstants.ManipulatorRollerState rollerGoal) {
    this.rollerGoal = rollerGoal;
    if ((hasAlgae() || hasCoral())
        && Set.of(
                V3_PootManipulatorConstants.ManipulatorRollerState.ALGAE_INTAKE,
                V3_PootManipulatorConstants.ManipulatorRollerState.CORAL_INTAKE,
                V3_PootManipulatorConstants.ManipulatorRollerState.STOP)
            .contains(rollerGoal)) {
