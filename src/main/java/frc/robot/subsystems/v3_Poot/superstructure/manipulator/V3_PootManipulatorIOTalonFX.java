package frc.robot.subsystems.v3_Poot.superstructure.manipulator;
...
public class V3_PootManipulatorIOTalonFX implements V3_PootManipulatorIO {
  ...
  public V3_PootManipulatorIOTalonFX() {
    armTalonFX = new TalonFX(V3_PootManipulatorConstants.ARM_CAN_ID);
    rollerTalonFX = new TalonFX(V3_PootManipulatorConstants.ROLLER_CAN_ID);
    canRange = new CANrange(V3_PootManipulatorConstants.CAN_RANGE_ID);

    armConfig = new TalonFXConfiguration();

    armConfig.MotorOutput.NeutralMode = NeutralModeValue.Brake;
    armConfig.CurrentLimits.SupplyCurrentLimit =
        V3_PootManipulatorConstants.CURRENT_LIMITS.MANIPULATOR_SUPPLY_CURRENT_LIMIT();
    armConfig.CurrentLimits.SupplyCurrentLimitEnable = true;
    armConfig.CurrentLimits.StatorCurrentLimit =
        V3_PootManipulatorConstants.CURRENT_LIMITS.MANIPULATOR_STATOR_CURRENT_LIMIT();
    armConfig.CurrentLimits.StatorCurrentLimitEnable = true;
    armConfig.Feedback.SensorToMechanismRatio =
        V3_PootManipulatorConstants.ARM_PARAMETERS.GEAR_RATIO();
    armConfig.Slot0 =
        Slot0Configs.from(V3_PootManipulatorConstants.EMPTY_GAINS.toTalonFXSlotConfigs());
    armConfig.Slot1 =
        Slot1Configs.from(V3_PootManipulatorConstants.CORAL_GAINS.toTalonFXSlotConfigs());
    armConfig.Slot2 =
        Slot2Configs.from(V3_PootManipulatorConstants.ALGAE_GAINS.toTalonFXSlotConfigs());
    ...
    rollerConfig.CurrentLimits.SupplyCurrentLimit =
        V3_PootManipulatorConstants.CURRENT_LIMITS.ROLLER_SUPPLY_CURRENT_LIMIT();
