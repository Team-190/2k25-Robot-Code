...
public class V3_PootIntake {
  private final V3_PootIntakeIO io;
  private final V3_PootIntakeIOInputsAutoLogged inputs;
  ...
  public V3_PootIntake(V3_PootIntakeIO io) {
    this.io = io;
    inputs = new V3_PootIntakeIOInputsAutoLogged();
  ...
  public boolean pivotAtGoal() {
    return Math.abs(inputs.pivotPosition.getRadians() - pivotGoal.getAngle().getRadians())
        < V3_PootIntakeConstants.PIVOT_CONSTRAINTS.GOAL_TOLERANCE().getRadians();
  }
  ...
  public void setRollerGoal(IntakeRollerState rollerGoal) {
    ...
    if (hasCoralLocked()
        || hasCoralLoose()
            && Set.of(
                    V3_PootIntakeConstants.IntakeRollerState.ALGAE_INTAKE,
                    V3_PootIntakeConstants.IntakeRollerState.CORAL_INTAKE,
                    V3_PootIntakeConstants.IntakeRollerState.STOP)
                .contains(rollerGoal)) {
