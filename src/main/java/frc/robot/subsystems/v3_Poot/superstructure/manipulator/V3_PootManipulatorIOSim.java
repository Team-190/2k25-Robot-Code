...
public class V3_PootManipulatorIOSim implements V3_PootManipulatorIO {
  ...
  public V3_PootManipulatorIOSim() {
    armMotorSim =
        new SingleJointedArmSim(
            LinearSystemId.createSingleJointedArmSystem(
                V3_PootManipulatorConstants.ARM_PARAMETERS.MOTOR_CONFIG(),
                0.4389150229,
