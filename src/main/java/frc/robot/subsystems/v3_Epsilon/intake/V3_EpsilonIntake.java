...
public class V3_EpsilonIntake extends SubsystemBase {
    ...
    @Getter @AutoLogOutput(key = "Intake/Goal")
    ...
    public V3_EpsilonIntake(V3_EpsilonIntakeIO io) {
        ...
        characterizationRoutine = new SysIdRoutine(
            ...
            new SysIdRoutine.Mechanism(
                (volts) -> io.setPivotVoltage(volts.in(Volts)), null, this));
    ...
    public boolean atGoal() {
        return Math.abs(inputs.pivotPosition.getRadians() - goal.getAngle().getRadians()) < V3_EpsilonIntakeConstants.PIVOT_CONSTRAINTS.GOAL_TOLERANCE().getRadians();
    }
