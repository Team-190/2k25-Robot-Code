...
public class V3_EpsilonIntakeIOTalonFX implements V3_EpsilonIntakeIO {
  ...
  private final MotionMagicVoltage pivotMotionMagicRequest;
    ...
    public V3_EpsilonIntakeIOTalonFX() {
        ...
        pivotConfig.CurrentLimits.SupplyCurrentLimit = V3_EpsilonIntakeConstants.CURRENT_LIMITS.PIVOT_SUPPLY_CURRENT_LIMIT();
        pivotConfig.CurrentLimits.StatorCurrentLimitEnable = true;
        pivotConfig.CurrentLimits.StatorCurrentLimit = V3_EpsilonIntakeConstants.CURRENT_LIMITS.PIVOT_STATOR_CURRENT_LIMIT();
        pivotConfig.Feedback.SensorToMechanismRatio = V3_EpsilonIntakeConstants.PIVOT_PARAMS.PIVOT_GEAR_RATIO();
        pivotConfig.SoftwareLimitSwitch.ForwardSoftLimitEnable = true;
        pivotConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = V3_EpsilonIntakeConstants.PIVOT_PARAMS.MIN_ANGLE().getRotations();
        pivotConfig.SoftwareLimitSwitch.ReverseSoftLimitEnable = true;
        pivotConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = V3_EpsilonIntakeConstants.PIVOT_PARAMS.MAX_ANGLE().getRotations();
        pivotConfig.MotorOutput.NeutralMode = NeutralModeValue.Brake;
        pivotConfig.MotorOutput.Inverted = InvertedValue.CounterClockwise_Positive;
        pivotConfig.Slot0 = new Slot0Configs().withGravityType(GravityTypeValue.Arm_Cosine)
        ...
        pivotConfig.MotionMagic = new MotionMagicConfigs()
            .withMotionMagicCruiseVelocity(AngularVelocity.ofRelativeUnits(V3_EpsilonIntakeConstants.PIVOT_CONSTRAINTS.CRUISING_VELOCITY_RADIANS_PER_SECOND(), RadiansPerSecond))
            .withMotionMagicAcceleration(AngularAcceleration.ofRelativeUnits(V3_EpsilonIntakeConstants.PIVOT_CONSTRAINTS.MAX_ACCELERATION_RADIANS_PER_SECOND_SQUARED(), RadiansPerSecondPerSecond));
        ...
        rollerConfig.CurrentLimits.SupplyCurrentLimit = V3_EpsilonIntakeConstants.CURRENT_LIMITS.ROLLER_SUPPLY_CURRENT_LIMIT();
        rollerConfig.CurrentLimits.StatorCurrentLimitEnable = true;
        rollerConfig.CurrentLimits.StatorCurrentLimit = V3_EpsilonIntakeConstants.CURRENT_LIMITS.ROLLER_STATOR_CURRENT_LIMIT();
        rollerConfig.Feedback.SensorToMechanismRatio = V3_EpsilonIntakeConstants.ROLLER_PARAMS.PIVOT_GEAR_RATIO();
        ...
        pivotMotionMagicRequest = new MotionMagicVoltage(V3_EpsilonIntakeConstants.PIVOT_PARAMS.MIN_ANGLE().getMeasure());
