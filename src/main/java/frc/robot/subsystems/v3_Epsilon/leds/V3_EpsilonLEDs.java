package frc.robot.subsystems.v3_Epsilon.leds;
...
public class V3_EpsilonLEDs extends Leds {
  ...
  private static final int LENGTH = 203;
  ...
  public V3_EpsilonLEDs() {
    super(LENGTH, PORT);
  }

  public static Leds getInstance() {
    if (instance == null) {
      instance = new V3_EpsilonLEDs();
    }
    return instance;
  }
