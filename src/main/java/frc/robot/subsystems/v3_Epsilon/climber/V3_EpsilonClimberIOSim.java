...
public class V3_EpsilonClimberIOSim implements V3_EpsilonClimberIO {
  ...
  public V3_EpsilonClimberIOSim() {
    sim =
        new DCMotorSim(
            LinearSystemId.createDCMotorSystem(
                V3_EpsilonClimberConstants.MOTOR_PARAMETERS.MOTOR_CONFIG(),
                0.004,
                V3_EpsilonClimberConstants.MOTOR_PARAMETERS.GEAR_RATIO()),
            V3_EpsilonClimberConstants.MOTOR_PARAMETERS.MOTOR_CONFIG());
  ...
  public void updateInputs(V3_EpsilonClimberIOInputs inputs) {
    ...
    inputs.deploymentSupplyCurrentAmps =
        sim.getCurrentDrawAmps() / V3_EpsilonClimberConstants.MOTOR_PARAMETERS.GEARBOX_EFFICIENCY();
