...
public class V3_SuperstructureEdges {
  ...
  public static void createEdges() {
    List<V3_SuperstructureStates> coralPrepLevels =
        List.of(
    ...
    List<V3_SuperstructureStates> coralTransitionLevels =
        List.of(
    ...
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L1_PREP,
            V3_SuperstructureStates.HANDOFF,
    ...
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L1_PREP, V3_SuperstructureStates.L1_SCORE, "Coral Score L1"));
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L2_PREP, V3_SuperstructureStates.L2_SCORE, "Coral Score L2"));
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L3_PREP, V3_SuperstructureStates.L3_SCORE, "Coral Score L3"));
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L4_PREP, V3_SuperstructureStates.L4_SCORE, "Coral Score L4"));

    // L1_SCORE -> GROUND_INTAKE
    CoralEdges.add(
        new Edge(
            V3_SuperstructureStates.L1_PREP,
            V3_SuperstructureStates.GROUND_INTAKE,
            "Coral Transition L1"));
    ...
    AlgaeEdges.add(
        new Edge(
            V3_SuperstructureStates.L2_ALGAE_PREP,
            V3_SuperstructureStates.L2_ALGAE_INTAKE,
            "Algae Intake L2"));
    AlgaeEdges.add(
        new Edge(
            V3_SuperstructureStates.L3_ALGAE_PREP,
            V3_SuperstructureStates.L3_ALGAE_INTAKE,
            "Algae Intake L3"));
