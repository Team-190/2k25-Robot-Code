...
public class V3_EpsilonSuperstructure extends SubsystemBase {
     ...
     */
    @Getter
    private V3_EpsilonSuperstructureStates previousState;
     ...
     */
    @Getter
    private V3_EpsilonSuperstructureStates currentState;
     ...
     */
    @Getter
    private V3_EpsilonSuperstructureStates nextState;
     ...
     */
    @Getter
    private V3_EpsilonSuperstructureStates targetState;
